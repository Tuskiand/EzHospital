...
public class UserBasicInfoServiceImpl implements IUserBasicInfoService {
     ...
     * true：阿里云短信服务mock
     */
    @Value("${mockService.aliSmsMock}")
    private Boolean ALI_SMS_MOCK;

    /**
     * true：reids服务mock
     */
    @Value("${mockService.redisMock}")
    private Boolean REDIS_MOCK;
    ...
    public boolean sendMessage(String phone) {
        ...
        String code = ALI_SMS_MOCK ? MOCK_AUTH_CODE_VALUE : RandomUtil.randomNumbers(AUTH_CODE_LENGTH);
