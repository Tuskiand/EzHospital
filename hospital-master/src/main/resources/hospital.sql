...
INSERT INTO `hospital`.`hospital_info`(`id`, `name`, `phone`, `address`, `description`, `picture`, `gmt_create`,
                                       `gmt_modified`)
VALUES (1000, '广东省中医院', '020-123452', '广州大学城', '广东省中医院', 'https://img.picui.cn/free/2025/06/11/6849574b96636.jpg',
        '2020-02-05 13:06:55', '2020-03-16 09:57:16');
INSERT INTO `hospital`.`hospital_info`(`id`, `name`, `phone`, `address`, `description`, `picture`, `gmt_create`,
                                       `gmt_modified`)
VALUES (1001, '顺德分院', '020-1234567', '广东省佛山市顺德区', '位于广东省佛山市顺德区',
        'https://img.picui.cn/free/2025/06/11/6849574cd6865.png', '2020-03-16 08:00:03', '2020-03-16 08:00:03');
INSERT INTO `hospital`.`hospital_info`(`id`, `name`, `phone`, `address`, `description`, `picture`, `gmt_create`,
                                       `gmt_modified`)
VALUES (1002, '白云分院', '020-1234568', '广东省广州市白云区', '位于广东省广州市白云区',
        'https://img.picui.cn/free/2025/06/11/6849594273095.jpg', '2020-03-16 08:03:30', '2020-03-16 08:03:30');
INSERT INTO `hospital`.`hospital_info`(`id`, `name`, `phone`, `address`, `description`, `picture`, `gmt_create`,
                                       `gmt_modified`)
VALUES (1007, '越秀分院', '020-1234563', '广东省越秀区', '位于广东省越秀区', 'https://img.picui.cn/free/2025/06/11/6849574bea8cd.jpg',
